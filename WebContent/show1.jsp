<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@page import="com.xie.spot.pojo.PjShow1" %>
<%
	PjShow1 bean = new PjShow1();
	if(!bean.action()){
		out.println("数据获取失败");
	}else{
%>
...
<p style="padding-left:15px;">截止<%= bean.getNowTime() %>，<span class="font24">神仙居景区</span> 累计游客进入：<span class="font24"><%= bean.getSumIn() %></span> 人，离开：<span class="font24"><%= bean.getSumOut() %></span> 人，留存：<span class="font24"><%= bean.getSumStay() %></span> 人</p>
<table width="98%" border="0" cellpadding="1">
  <tr>
    <td width="25%" align="center">
	    ...
	    %>
	      <tr>
	        <td align="center"><img src="<%= bean.getCmrPicUrl(sn) %>" width="240" height="135" /></td>
	      </tr>
	      <tr>

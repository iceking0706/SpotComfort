...
public class SendMail {
	 ...
	 * @return
	 */
	public static boolean send126Mail(String subject,String text){
		try {
			sendMessage("smtp.126.com", "suyou360@126.com",
					"mdafkonustouknld", "suyou360@126.com", subject,
					text,
...
//		boolean result = send126Mail("王冰测试111", "测试邮件：<br/>111111<br/>22222222");
